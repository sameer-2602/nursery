...
if($_REQUEST['catid'] != 0){
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM product where cat_id = $catid";
}else{
...
if(isset($_REQUEST['catid']) && $_REQUEST['catid']!=0){
    $catid = $_REQUEST['catid']; 
$sql = "SELECT * FROM product where cat_id= '$catid' LIMIT $offset, $no_of_records_per_page";
}else{
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <li><a href="shop.php?catid=0"
                            class="<?php if($_REQUEST['catid'] == 0){echo  'active';}else{echo "";} ?>">All</a></li>
                    <?php foreach($cat as $catval): ?>
                    <li><a class="<?php if($catval['id'] == $_REQUEST['catid']){echo  'active';}else{echo "";}?>"
                            href="shop.php?catid=<?=$catval['id']?>"><?=$catval['name']?></a></li>
                    <?php endforeach ?>
                </ul>
            </div>
        </div>
        <div class="row">
            <?php while ($val = mysqli_fetch_array($res_data)): ?>
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    <a href="product_detail.php?data_product_id=<?=$val['id'];?>" class="img-prod"><img
                            class="img-fluid" style="height: 235px !important;" src="./assets/images/<?=$val['image']?>" alt="Colorlib Template">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="bottom-area d-flex px-3">
                            <div class="m-auto d-flex">
                                ...
                                <a href="addcart.php?data_product_id=<?=$val['id']?>"
            ...
            <!-- <div class="col-md-6 col-lg-3 ftco-animate">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="./assets/images/product-9.jpg"
                                alt="Colorlib Template">
                            <span class="status">30%</span>
                            <div class="overlay"></div>
                        </a>
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="./assets/images/product-10.jpg"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="./assets/images/product-11.jpg"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="./assets/images/product-12.jpg"
                                alt="Colorlib Template">
                            <div class="overlay"></div>
                        </a>
                        <div class="text py-3 pb-4 px-3 text-center">
                    ...
                    <ul class="pagination">
                        ...
                        $pagLink;
                            for ($i=1; $i<=$total_pages; $i++) {
                                ...
                                if ($i==$pn) {
                                    $pagLink .= "<li class='active'><a href='shop.php?pageno="
                                        .$i."&catid=".$_REQUEST['catid']."'>".$i."</a></li>";
                                }
                                else  {
                                    $pagLink .= "<li><a href='shop.php?pageno=".$i."&catid=".$_REQUEST['catid']."'>
                                                              ".$i."</a></li>";
                                }
                            };
                            echo $pagLink;
