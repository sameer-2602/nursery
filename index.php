...
$related_products = $con->query("select * from product");
    ...
    <section class="ftco-section">
		...
		<div class="row">
                ...
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="product_detail.php?data_product_id=<?=$val['id'];?>" class="img-prod"><img style="height: 235px !important;" class="img-fluid" src="./assets/images/<?=$val['image']?>"
                                alt="">
